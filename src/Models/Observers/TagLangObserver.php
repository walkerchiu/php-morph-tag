...
namespace WalkerChiu\MorphTag\Models\Observers;

class TagLangObserver
{
    /**
    ...
    {
        $query =
            config('wk-core.class.morph-tag.tagLang')::withTrashed()
        ...
        if (config('wk-core.lang_log') || config('wk-morph-tag.lang_log'))
