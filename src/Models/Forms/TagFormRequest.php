...
class TagFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($request->isMethod('put') && isset($request->id)) {
            $rules = array_merge($rules, ['id' => ['required','string','exists:'.config('wk-core.table.morph-tag.tags').',id']]);
        }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['host_type']) && isset($data['host_id'])) {
                if ( config('wk-morph-tag.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['host_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-morph-tag.onoff.group') && !empty(config('wk-core.class.group.store')) && $data['host_type'] == config('wk-core.class.group.store') ) {
