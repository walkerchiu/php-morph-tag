...
class TagRepository extends Repository
{
     ...
     * @return Array
     */
    public function listOption(?string $host_type, ?string $host_id, string $code): array
    {
        if (
            empty($host_type)
            || empty($host_id)
     ...
     * @return Array
     */
    public function listTag(?string $host_type, ?string $host_id, string $code, ?string $target, ?bool $target_is_enabled): array
    {
        if (
            empty($host_type)
            || empty($host_id)
